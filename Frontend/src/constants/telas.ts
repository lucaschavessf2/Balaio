...
export const telas: Tela[] = [
  ...
  { rota: '/artisans/mestre-nuca', nome: 'Perfil do artesão', descricao: 'História, técnica, território e peças disponíveis do ateliê.', fluxo: 'comprador', requisitos: ['PI-33', 'RF-02', 'RF-12'] },
  ...
  { rota: '/checkout', nome: 'Revisão da compra', descricao: 'Itens, entrega, frete e total antes de confirmar o pedido simulado.', fluxo: 'comprador', requisitos: ['PI-41', 'RF-18', 'RF-10'] },
  { rota: '/confirmation/PE-2026-8941', nome: 'Pedido confirmado', descricao: 'Resumo da compra e próximos passos.', fluxo: 'comprador', requisitos: ['PI-41', 'RF-06'] },
  { rota: '/orders', nome: 'Meus pedidos', descricao: 'Lista com o estado de cada compra.', fluxo: 'comprador', requisitos: ['PI-44', 'RF-06'] },
  { rota: '/orders/PE-2026-8941', nome: 'Acompanhamento', descricao: 'Linha do tempo, rastreio e conversa com o artesão.', fluxo: 'comprador', requisitos: ['PI-44', 'RF-06', 'RF-08'] },
  { rota: '/orders/PE-2026-8720/review', nome: 'Avaliação', descricao: 'Nota geral, critérios e comentário para uma compra entregue.', fluxo: 'comprador', requisitos: ['PI-46', 'RF-11'] },
